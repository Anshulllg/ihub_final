...
const CollabPage = () => {
 ...
 const deleteEvent = (id) => {
    axios.delete(`https://ihub-hbkk.onrender.com/collab/delete/${id}`)
    .then(res => {
     if (res.status === 200) {
   ...
   const addEvent = () => {
    convertBase64(image1, image2, image3, image4).then(base64Images => {
      axios.post("https://ihub-hbkk.onrender.com/collab/add", {
        name: name,
        type: type,
...
const handleImageChange4= (e) => {
 ...
 axios.put(`https://ihub-hbkk.onrender.com/collab/${id}`, updatedEvent)
 .then(() => {
...
<textarea
  ...
  name="type"
  value={type}
  placeholder="Type: Academics/Industry"
  rows={3}
></textarea>
